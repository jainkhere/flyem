...
class ImageView:
    ...
    @staticmethod
    def display_and_save_compare_labeled(data1, data2, data3, plot_path, show_in_notebook):
        ImageUtils.display_and_save_compare_labeled(data1, data2, data3, plot_path, show_in_notebook=show_in_notebook)